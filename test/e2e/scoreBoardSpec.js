...
describe('/#/score-board', () => {
  ...
  describe('challenge "continueCode"', () => {
    it('should be possible to solve the non-existent challenge #99', () => {
      browser.executeScript('var $http = angular.injector([\'swagStore\']).get(\'$http\'); $http.put(\'/rest/continue-code/apply/69OxrZ8aJEgxONZyWoz1Dw4BvXmRGkKgGe9M7k2rK63YpqQLPjnlb5V5LvDj\');')
      browser.get('/#/score-board')
    })
